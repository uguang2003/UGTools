...
import top.ug666.ug.tools.dao.TQrCodeMapper;
...
import top.ug666.ug.tools.ui.Style;
import top.ug666.ug.tools.ui.listener.func.QrCodeListener;
...
public class QrCodeForm {
    ...
    private static void initUi() {
        ...
        if (tQrCode != null && StringUtils.isNotEmpty(tQrCode.getContent())) {
            ...
            qrCodeForm.getToGenerateContentTextArea().setText("https://example.com/UGTools");
        }
