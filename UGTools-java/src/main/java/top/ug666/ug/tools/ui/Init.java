...
import top.jthemedetecor.OsThemeDetector;
import top.ug666.ug.tools.App;
import top.ug666.ug.tools.ui.component.JPopupMenuMouseAdapter;
import top.ug666.ug.tools.ui.dialog.FontSizeAdjustDialog;
import top.ug666.ug.tools.ui.dialog.SettingDialog;
import top.ug666.ug.tools.ui.dialog.TranslationDialog;
import top.ug666.ug.tools.ui.form.AboutForm;

import top.ug666.ug.tools.ui.form.func.*;
...
//                SwingUtilities.windowForComponent(App.mainFrame).repaint();
    ...
    public static void initAllTab() {
        ...
        // 检查新版版
        if (App.config.isAutoCheckUpdate() && StringUtils.isNotBlank(UiConsts.CHECK_VERSION_URL)) {
...
//                App.popupMenu.setFont(App.mainFrame.getContentPane().getFont());
                ...
                JMenuItem openItem = new JMenuItem("UGTools");
                ...
                // 使用高清图标，系统会自动缩放
                App.trayIcon = new TrayIcon(UiConsts.IMAGE_LOGO_1024, "UGTools");
