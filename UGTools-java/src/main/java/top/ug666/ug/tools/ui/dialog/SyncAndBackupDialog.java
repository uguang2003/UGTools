...
import top.ug666.ug.tools.ui.listener.func.ImageListener;
...
public class SyncAndBackupDialog extends JDialog {
    ...
    public SyncAndBackupDialog() {
        ...
        String localDataPath = SystemUtil.CONFIG_HOME + File.separator + "UGTools.db";
        ...
        exportDataButton.addActionListener(e -> {
            ...
            File exportFile = FileUtil.touch(exportPath + File.separator + "UGTools.db");
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        label1.setText("用于同步UGTools数据的Git仓库地址：");
