...
import top.ug666.ug.tools.dao.THttpRequestHistoryMapper;
import top.ug666.ug.tools.dao.TMsgHttpMapper;
import top.ug666.ug.tools.domain.TMsgHttp;
import top.ug666.ug.tools.service.HttpMsgMaker;
import top.ug666.ug.tools.service.HttpMsgSender;
import top.ug666.ug.tools.service.HttpSendResult;
import top.ug666.ug.tools.ui.form.MainWindow;
import top.ug666.ug.tools.ui.form.func.HttpRequestForm;
import top.ug666.ug.tools.ui.form.func.HttpResultForm;
import top.ug666.ug.tools.ui.frame.HttpResultFrame;
import top.ug666.ug.tools.ui.dialog.JsonResultDialog;
import top.ug666.ug.tools.util.CurlParserUtil;
import top.ug666.ug.tools.util.AutoIndentDocumentFilter;
import top.ug666.ug.tools.util.MybatisUtil;
import top.ug666.ug.tools.util.SqliteUtil;
import lombok.extern.slf4j.Slf4j;
import org.apache.commons.lang3.StringUtils;
import org.apache.commons.lang3.exception.ExceptionUtils;
import org.apache.commons.lang3.time.DateFormatUtils;
import top.ug666.ug.tools.util.XmlReformatUtil;
            ...
            httpRequestForm.getBodyFormatButton().addActionListener(e -> {
                try {
                    ...
                    if ("application/json".equalsIgnoreCase(bodyType)) {
                        ...
                        formatted = XmlReformatUtil.format(text);
                    } else {
