...
public class UpdateDialog extends JDialog {
    ...
    public UpdateDialog() {
        ...
        buttonDownloadFromWeb.addActionListener(e -> {
            if (StringUtils.isBlank(UiConsts.DOWNLOAD_LINK_INFO_URL)) {
            ...
            try {
                desktop.browse(new URI("https://example.com/UGTools/releases"));
    ...
    public void downLoad(String newVersion) {
        ...
        ThreadUtil.execute(
                () -> {
                    ...
                    File tempDir = new File(FileUtil.getTmpDirPath() + "UGTools");
                    if (!tempDir.exists()) {
                        tempDir.mkdirs();
                    }
