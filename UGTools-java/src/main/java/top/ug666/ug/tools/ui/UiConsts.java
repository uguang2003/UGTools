...
public class UiConsts {
     ...
     * 软件名称,版本
     */
    public static final String APP_NAME = "UGTools";
     ...
     * 软件下载链接信息url
     */
    public static final String DOWNLOAD_LINK_INFO_URL = "";

    /**
     * Grace信息url
     */
    public static final String GRACE_INFO_URL = "";
     ...
     * DAU信息url
     */
    public static final String DAU_URL = "";
}
