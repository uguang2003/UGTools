...
import top.ug666.ug.tools.ui.dialog.SupportMeDialog;
import top.ug666.ug.tools.ui.dialog.UpdateInfoDialog;
...
public class UpgradeUtil {
    ...
    public static void checkUpdate(boolean initCheck) {
        if (StringUtils.isBlank(UiConsts.CHECK_VERSION_URL)) {
            if (!initCheck) {
                JOptionPane.showMessageDialog(App.mainFrame,
                        "当前未配置在线更新源，暂不执行检查。", "提示",
